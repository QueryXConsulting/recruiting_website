                        ...
                        <el-row justify="center" :gutter="50" class="user-info-row">
                            ...
                            <el-col v-for="(_, index) in formDisplay" :key="index" :span="8" class="user-info-col">
                                ...
                                <el-radio-group v-if="index === 'resumeGender'" :disabled="notEdit" class="user-info-input"
                                    v-model="formData[index]" size="large" :style="{ width: '260px' }">
                                ...
                                <el-select v-else-if="index === 'resumePolitical' ||
                                    ...
                                    placeholder="请选择" size="large" :disabled="notEdit" :style="{ width: '260px' }">
                                    <!-- 政治背景 -->
                                ...
                                <el-date-picker v-else-if="index === 'resumeBirth'" v-model="formData[index]" type="date"
                                    placeholder="选择出生日期" :disabled="notEdit" size="large"
                                    :style="{ width: '260px' }" class="user-info-input" />
                                <!-- 期待薪资 -->
                                <span v-else-if="index === 'resumeSalary'" :style="{ width: '260px', display: 'inline-block' }">
                                    <el-select v-model="salaryRange[0]" placeholder="请选择" size="large" :disabled="notEdit"
                                        class="user-info-input" :style="{ width: '110px' }">
                                        <el-option v-for="(item, i) in salaryOptions" :key="i" :label="item.range"
                                            :value="item.range"></el-option>
                                    </el-select>
                                    <em style="color: #999;margin: 0 10px;vertical-align: sub;font-size: 20px;">至</em>
                                ...
                                <!-- 其他 -->
                                <el-input v-else v-model="formData[index]" :disabled="notEdit" size="large"
                                    class="user-info-input" :style="{ width: '260px' }" />
                            </el-col>
                            <!-- 提交按钮 -->
